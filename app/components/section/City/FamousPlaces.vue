      ...
      <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16 items-stretch">
        ...
        <div class="w-full lg:w-1/2 xl:w-[45%]">
          <div class="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-full min-h-[400px] rounded-2xl overflow-hidden">
            ...
            >
              <p class="text-grey-darker text-sm">{{ t('cities.famousPlaces.title') }}</p>
            </div>
        ...
        <div class="w-full lg:w-1/2 xl:w-[55%] flex flex-col justify-center">
          <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-dark-normal leading-tight mb-6 sm:mb-8 font-display">
            {{ t('cities.famousPlaces.title') }}
          </h2>

          <!-- Loading -->
          <div v-if="loadingFamousPlaces" class="space-y-2">
            <div v-for="i in 3" :key="i" class="h-12 bg-grey-normal/20 rounded animate-pulse" />
          </div>
            ...
            >
              ...
              >
                <div class="flex items-start gap-4">
                  ...
                  <div class="flex-1">
                    <h3
                      class="text-lg sm:text-xl font-semibold transition-colors duration-300 text-dark-normal"
                    >
                      {{ place.name }}
                    </h3>
                    ...
                    <div
                      ...
                      :class="activeItem === index ? 'max-h-[500px] opacity-100 mt-3' : 'max-h-0 opacity-0'"
                    >
                      <div
                        class="text-grey-darker text-sm sm:text-base leading-relaxed prose prose-sm max-w-none"
